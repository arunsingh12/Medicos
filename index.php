...
<body>
    ...
    <section class="doctors reveal" id="doctors">
    ...
    <section class="appoinment reveal" id="appoinment">
        ...
        <form action="" method="post">
            ...
            ?>
            <br>
            <input placeholder="Your Name" name="name" type="text" required class="box">
            <input placeholder="Your Email" name="email" type="email" required class="box">
            <input type="date" name="date" required class="box"><br><br>
